...
export default function Hero() {
  return (
    <div className="relative overflow-hidden flex flex-col justify-between">
      ...
      {/* HeroSection */}
      <section className="relative z-10 w-full pt-20 md:pt-24 pb-24 md:pb-20 min-h-[100vh] sm:min-h-[90vh] flex items-center" data-purpose="hero-content">
        <div className="w-full max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
          {/* Hero Text & CTA */}
          <div className="max-w-4xl space-y-5 pt-12 sm:pt-28 md:pt-52">
