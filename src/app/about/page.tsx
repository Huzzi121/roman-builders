    ...
    <main className="relative min-h-screen">
      ...
      <section className="pt-28 pb-28 md:pt-36 md:pb-36 px-6 sm:px-8 relative text-center">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-white mb-6 drop-shadow-lg">Our Story</h1>
      ...
      <section className="pt-0 pb-10 lg:pb-16 px-6 sm:px-8 -mt-6 md:-mt-10 relative z-20">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-[#4a5240]/85 backdrop-blur-md p-8 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.1)] border border-transparent hover:-translate-y-1 transition-transform duration-300 flex flex-col h-full cursor-pointer">
            ...
            <div className="w-12 h-12 bg-[#3d4435] text-white rounded-full flex items-center justify-center -mt-6 ml-4 relative z-10 border-[3px] border-white/20 shadow-md mb-4 shrink-0">
              <i className="fa-solid fa-eye text-sm"></i>
            </div>
            <h3 className="text-xl font-serif text-white mb-3">Our Vision</h3>
          ...
          <div className="bg-[#4a5240]/85 backdrop-blur-md p-8 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.1)] border border-transparent hover:-translate-y-1 transition-transform duration-300 flex flex-col h-full cursor-pointer">
            ...
            <h3 className="text-xl font-serif text-white mb-3">Our Mission</h3>
            <p className="text-white/90 text-sm leading-relaxed">
          ...
          <div className="bg-[#4a5240]/85 backdrop-blur-md p-8 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.1)] border border-transparent hover:-translate-y-1 transition-transform duration-300 flex flex-col h-full cursor-pointer">
            ...
            <h3 className="text-xl font-serif text-white mb-3">Our Values</h3>
            <p className="text-white/90 text-sm leading-relaxed">
