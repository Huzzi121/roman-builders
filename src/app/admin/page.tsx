          ...
          <div className="mb-8">
            ...
            <div className="mt-2 space-y-1">
              <p className="text-[10px] text-blue-500">
                URL starts with: {process.env.NEXT_PUBLIC_SUPABASE_URL?.substring(0, 15) || 'MISSING'}
              </p>
              <p className="text-[10px] text-blue-500">
                Key starts with: {process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY?.substring(0, 15) || 'MISSING'}
              </p>
            </div>
